                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{url('/file/delete/'.$a->id)}}" method="POST" style="display:inline-block;">
                                        @csrf
...
<div class="modal fade" id="fileModalRequest" tabindex="-1" role="dialog" aria-labelledby="poliModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form enctype="multipart/form-data" action="{{ url('/file/store') }}" method="post">
                @csrf
